 ...
 * Note:
 *
 * This file is not meant for compilation, it just contains annotations
 * for gobject-introspection.
 */

/**
 * gami_manager_login:
 * @auth_type: (allow-none):
 ...
 * @priority: (allow-none):
 * @caller_id: (allow-none):
 * @account: (allow-none):
 * @variables: (allow-none) (element-type utf8 utf8):
 * @action_id: (allow-none):
 */
 ...
 * @headers: (allow-none) (element-type utf8 utf8):
 * @action_id: (allow-none):
 */
